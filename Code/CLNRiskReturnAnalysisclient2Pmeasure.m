function [meanreturn, meanexcessreturn, stdexcessreturn, sharpe, elapsedTime] = CLNRiskReturnAnalysisclient2Pmeasure ...
...
% Calculates payoff.
payoff= par.*max((1/3).*min((SCuT)./Cu_P,1.25)...
                    +(1/3).*min((SAlT)./Al_P,1.25)...
                    +(1/3).*min((SZnT)./Zn_P,1.25),1.09);
