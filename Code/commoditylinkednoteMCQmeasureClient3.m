function [meanreturn,meanexcessreturn,stdexcessreturn,fairvalue,sharpe, CI , elapsedTime, discpayoffs] = commoditylinkednoteMCQmeasureClient3 ...
...
discpayoffs= exp(-r.*T).*1000000.*max((1/3).*(SCuT./Cu_P)...
                    +(1/3).*(SAlT./Al_P)...
                    +(1/3).*(SZnT./Zn_P),1.04);
