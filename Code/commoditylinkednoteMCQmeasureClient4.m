function [meanreturn,meanexcessreturn,stdexcessreturn,fairvalue,sharpe, CI , elapsedTime, discpayoffs] = commoditylinkednoteMCQmeasureClient4 ...
...
discpayoffs= exp(-r.*T).*1000000.*max((1/3).*min((SCuT)./Cu_P,1.7)...
